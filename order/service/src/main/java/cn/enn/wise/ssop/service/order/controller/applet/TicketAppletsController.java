...
import cn.enn.wise.ssop.api.order.dto.request.TicketOrderParam;
...
import cn.enn.wise.ssop.service.order.service.impl.TicketOrderServiceImpl;
...
@Slf4j
@RestController
@RequestMapping("/applets/ticket")
@Api(value = "小程序门票订单API", tags = {"小程序门票订单API"})
public class TicketAppletsController {
    ...
    @Autowired
    private TicketOrderServiceImpl ticketService;
...
//    }
    ...
    public R<Boolean> backTicket(@RequestBody TicketCancelParam ticketCancelParam){
        ...
        ticketCancelParam.setRefundType((byte)1);
        if(orderInfo==null){
