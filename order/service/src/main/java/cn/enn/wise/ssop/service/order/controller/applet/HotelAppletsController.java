...
@Slf4j
@RestController
@RequestMapping("/applets/hotel")
@Api(value = "小程序酒店订单API", tags = {"小程序酒店订单API"})
public class HotelAppletsController {
    ...
    public R<Boolean> cancel(Long orderId){
        ...
        if(b){
            boolean b1 = orderService.updateOrderStatus(orderGoodsInfo.getOrderId(), OrderStatusEnum.HOTEL_CANCEL,PayStatusEnum.UN_PAY,
                    null,null,null,
                    null,null,null,null,
    ...
    public R<Boolean> sendConfirm(Long orderId){
        ...
        if(b){
            boolean u = orderService.updateOrderStatus(orderId, OrderStatusEnum.HOTEL_WAIT_USE,PayStatusEnum.PAYED,
    ...
    public R<Boolean> checkPassRefund(Long orderId){
        ...
        if(b){
            boolean u = orderService.updateOrderStatus(orderId, OrderStatusEnum.HOTEL_CANCEL,PayStatusEnum.PAYED,
  ...
  /*  *//**
    ...
    public R<Boolean> ruZhuCheck(Long orderId){
        ...
        boolean b = StatusCheck.checkOrderInfoStatus(orderGoodsInfo,OrderStatusEnum.HOTEL_WAIT_USE, PayStatusEnum.PAYED,
                TransactionStatusEnum.HOTEL_WAIT_ZHU,null,null);
        if(b){
            boolean u = orderService.updateOrderStatus(orderId, OrderStatusEnum.HOTEL_USED,PayStatusEnum.PAYED,
