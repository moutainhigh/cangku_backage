 ...
 */
@Data
@Table(name = "coupon_full_reduce_rule")
public class CouponFullReduceRule extends TableBase {
    ...
    @Column(name = "satisfy_price",type = MySqlTypeConstant.INT,length = 20,comment = "满足多少价钱的金额")
    ...
    @Column(name = "rebate_price",type = MySqlTypeConstant.INT,length = 20,comment = "加价多少/折扣多少")
