...
@Table(name = "strategy")
public class Strategy extends TableBase {
     ...
     * 作者
     */
    @Column(name = "auther",type = MySqlTypeConstant.VARCHAR,length = 300,defaultValue = "",comment = "作者")
     ...
     * 知识ids，逗号隔开
     */
    @Column(name = "knowledge_ids",type = MySqlTypeConstant.VARCHAR,length = 100,defaultValue = "",comment = "知识ids，逗号隔开")
     ...
     * 评论量
     */
    @Column(name = "comment_number",type = MySqlTypeConstant.INT,defaultValue = "0",comment = "评论量")
     ...
     * 语音讲解
     */
    @Column(name = "voice_url",type = MySqlTypeConstant.VARCHAR,length = 300,defaultValue = "",comment = "语音讲解")
