...
//    String swaggerHost;
    ...
    public Docket createRestApi() {
        ...
        memberId.name("member_id").description("小程序用户id(前端不需要关注，只用于页面测试)").modelRef(new ModelRef("string")).parameterType("header").required(false).defaultValue("1").build();
        ...
        Docket build = new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("cn.enn.wise.ssop.service.cms.controller"))
