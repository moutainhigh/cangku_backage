...
public final class RedisUtil {
    ...
    public  Set<Object> getPage(String key, int offset, int count){
        ...
        try {
            result = redisTemplate.opsForZSet().rangeByScore(key, 1, 2.585962527E12, (offset-1)*count, count);//1 100000代表score的排序氛围值，即从1-100000的范围
    ...
    public Boolean valueSetIfAbsent(final String key, Object value, Long expireTime) {
        ValueOperations<String, Object> operations = redisTemplate.opsForValue();
        return operations.setIfAbsent(key, value, expireTime, TimeUnit.SECONDS);
    }

    /**
     * 根据 Key  Value 对score加一
     * @param key
     * @param value
     * @return
     */
    public Boolean zZsetByKeyValueAddScore(final String key, Object value) {
        Double score = redisTemplate.opsForZSet().score(key, String.valueOf(value));
        return redisTemplate.opsForZSet().add(key, String.valueOf(value), score == null ? 1 : score + 1);
    }
}