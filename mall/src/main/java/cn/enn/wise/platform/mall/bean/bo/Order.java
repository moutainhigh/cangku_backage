...
import cn.enn.wise.platform.mall.bean.vo.GroupItemVo;
import cn.enn.wise.platform.mall.bean.vo.OrderRefundVo;
...
public class Order implements Serializable {
    ...
    @ApiModelProperty(value = "订单类型 1 线上订单 2 离线订单 3拼团订单 4 套装 5 北海游船 6 佰邦达订单")
